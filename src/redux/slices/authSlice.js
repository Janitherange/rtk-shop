...
import {auth, db, googleProvider} from "../../auth/firebase.js";
import {
...
export const registerWithEmailAndPassword = createAsyncThunk('auth/registerWithEmailAndPassword', async ({name, email, password}, thunkAPI) => {
    try {
...
const authSlice = createSlice({
    ...
    extraReducers: (builder)=>{
        ...
        builder.addCase(registerWithEmailAndPassword.pending, (state, action) => {
            state.loading = "pending";
        });
