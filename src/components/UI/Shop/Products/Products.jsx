...
import {getProducts, productActions} from "../../../../redux/slices/productSlice.js";
...
export const Products = ({categoryName}) => {
    ...
    const visible = useSelector(state => state.product.visible);
    ...
    const filterOrChangeOrFetchProducts = () => {
        dispatch(productActions.filterByCategory({
            categoryMap: categoryMap(categoryType),
