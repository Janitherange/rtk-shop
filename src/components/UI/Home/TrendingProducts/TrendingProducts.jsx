...
export const TrendingProducts = () => {
    ...
    const trendingProducts = () => {
      setProducts(prods.filter(product => product.category === "chair"));
    }
    ...
    return(
        <>
            <div className="container flex flex-col place-content-center mx-auto">
                <h2 className="text-center pt-16 text-2xl md:text-3xl font-bold text-blue-gray-900">Trending Products</h2>
                            ...
                            <motion.div key={id} whileHover={{scale: 0.9}}>
                                <Card className="w-full shadow-none ">
                                   <CardHeader floated={false} className=" h-28 md:h-40 lg:h-56 shadow-none flex justify-center">
                                       <img src={item.imgUrl} alt={`trending-product-${id}`} className="h-full bg-cover"/>
                                   </CardHeader>
