...
import {registerWithEmailAndPassword, signInWithGoogle} from "../redux/slices/authSlice.js";
...
export const Signup = () => {
    ...
    const onRePasswordChange = (value) => {
        if (value.length) {
            const regex = new RegExp(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[a-zA-Z]).{8,}$/gm);
            if (regex.test(value)) {
                ...
                <div className="container flex flex-col mx-auto py-10 ">
                    <div className="grid md:grid-cols-2 lg:mx-60">
                        <div className="bg-white py-10 px-10 flex flex-col rounded-l-lg">
                            <img
                                src="https://firebasestorage.googleapis.com/v0/b/rtk-shop.appspot.com/o/background-images%2Fundraw_authentication_re_svpt.svg?alt=media&token=5ed861b4-756a-4300-a93b-a68baaf904e4"
                                alt="sign-up" className="w-auto h-[20rem]"/>
                            ...
                            <div className="my-10 mx-10">
                                <div className="my-5">
                                    <ThemeProvider value={themeInput}>
                                        <Input label="full name" color="blue-gray" variant="outlined"
                                               error={nameInvalid}
                                               success={nameValid}
                                               onChange={(e) => {
                                ...
                                <div className="my-5">
                                    <ThemeProvider value={themeInput}>
                                        <Input label="re-password"
                                               ...
                                               color="blue-gray"
                                               type="password"
                                               error={rePasswordInvalid}
                                               success={rePasswordValid}
                                               onChange={(e) => {
                                                   setRePassword(e.target.value);
                                                   onRePasswordChange(e.target.value);
                                               }}
                                        />
                                    </ThemeProvider>
                                </div>
                            ...
                            <div className="flex flex-col mx-10">
                                ...
                                >
                                    ...
                                    <div className="flex flex-col my-auto ml-2">
                                        <Typography variant="small" className="text-xs">Sign Up With Email</Typography>
                                    </div>
                                </Button>
                                <Button
                                ...
                                >
                                    ...
                                    <div className="flex flex-col my-auto ml-2">
                                        <Typography variant="small" className="text-xs">Sign Up With Google</Typography>
                                    </div>
                                </Button>
                            </div>
                        </div>
